...
enum ReleaseNotes {
    static var all: [ReleaseNote] {
        [
            ReleaseNote(
                version: "1.8.0",
                headline: L10n.t("Codex-only Russian edition"),
                changes: [
                    ReleaseNote.Change(title: L10n.t("Russian interface"),
                        detail: L10n.t("Settings, usage and notifications are available in Russian.")),
                    ReleaseNote.Change(title: "Codex",
                        detail: L10n.t("Only your default Codex account is used. Other providers and automatic updates are disabled."))
                ]
            ),
            ReleaseNote(
                version: "1.7.0",
