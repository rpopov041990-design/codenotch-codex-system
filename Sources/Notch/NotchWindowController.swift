...
final class NotchWindowController {
    ...
    func relocate(cellCount: Int? = nil) {
        ...
        let size = model.panelSize(cellCount: cellCount ?? model.displaySnapshots.count)
    ...
    func handleClick(at locationInWindow: CGPoint) {
        ...
        if notchRect.contains(local),
           ...
           model.displaySnapshots.indices.contains(index) {
    ...
    func cellIndex(along: CGFloat) -> Int? {
        ...
        for index in model.displaySnapshots.indices {
